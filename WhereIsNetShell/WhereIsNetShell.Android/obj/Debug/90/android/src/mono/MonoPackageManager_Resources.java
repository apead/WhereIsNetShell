...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "WhereIsNetShell.Android.dll" comes first in this list. */
		"WhereIsNetShell.Android.dll",
		"FormsViewGroup.dll",
		"GoogleGson.dll",
		...
		"Microsoft.AppCenter.Data.Android.Bindings.dll",
		"Microsoft.AppCenter.Data.dll",
